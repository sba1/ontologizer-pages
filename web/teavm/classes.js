...
function o_WorkerMessage31_$clinit() {
    ...
    o_WorkerMessage31_createWorkerMessage57 = function(a_cl) {
        ...
        return otj_JSObject29_cast$static56(o_WorkerMessage31_createWorkerMessage$js_body$_3658($rt_ustr(b), c));
    };
    o_WorkerMessage31_createWorkerMessage$js_body$_3658 = function(a, b) {
        return { type : a, id : b };
    };
...
function jur_SingleSet51_processSecondPass85($this) {
    ...
    if ($this.kid52 !== null) {
        ...
        jur_AbstractSet41_$clinit();
        if (a.isSecondPassVisited43 == 0) {
            a = $this.kid52.processBackRefReplacement84();
            if (a !== null) {
...
function jur_AbstractCharClass$182_contains30($this, a_ch) {
    ...
    if (a_ch >= 0 && a_ch < 2048) {
        ...
        b = $this.altSurrogates22 ^ ju_BitSet407_get112($this.val$lHS84, a_ch);
    } else {
        b = 0;
    }
    return b;
...
function jl_AbstractStringBuilder170_insert177($this, a_target, b_value, c_radix) {
    ...
    if (b_value < c_radix) {
        ...
        jl_AbstractStringBuilder170_insertSpace175($this, a_target, a_target + g | 0);
        if (d != 0) {
            f = a_target;
        } else {
        ...
        while (h > 0) {
            ...
            a_target = f + 1 | 0;
            g[f] = jl_Character478_forDigit180(b_value / h | 0, c_radix);
            b_value = b_value % h;
            h = h / c_radix | 0;
            f = a_target;
        }
...
function jl_AbstractStringBuilder170_insert181($this, a_index_j, b_string) {
    ...
    if (a_index_j >= 0 && a_index_j <= $this.length171) {
        ...
        while (d < jl_String1_length2(b_string)) {
            ...
            e = a_index_j + 1 | 0;
            c[a_index_j] = jl_String1_charAt61(b_string, d);
            d = d + 1 | 0;
            a_index_j = e;
        }
        return $this;
...
function jl_AbstractStringBuilder170_insert172($this, a_target, b_value) {
    ...
    if (b_value >= 1.0) {
        ...
        k = 0;
        m = 1.0;
        n = jl_AbstractStringBuilder170.doublePowersOfTen174.data.length - 1 | 0;
        while (n >= 0) {
            o = k | j;
            if (o <= 308 && jl_AbstractStringBuilder170.doublePowersOfTen174.data[n] * m <= b_value) {
                m = m * jl_AbstractStringBuilder170.doublePowersOfTen174.data[n];
                k = o;
            }
            j = j >> 1;
            n = n +  -1 | 0;
        }
        n = Long_fromNumber(b_value / m * 1.0E15 + 0.5);
    } else {
        m = 256;
        j = 0;
        o = 1.0;
        k = jl_AbstractStringBuilder170.negDoublePowersOfTen177.data.length - 1 | 0;
        while (k >= 0) {
            p = j | m;
            if (p <= 308 && jl_AbstractStringBuilder170.negDoublePowersOfTen177.data[k] * o * 10.0 > b_value) {
                o = o * jl_AbstractStringBuilder170.negDoublePowersOfTen177.data[k];
                j = p;
            }
            m = m >> 1;
            k = k +  -1 | 0;
        ...
        k =  -j | 0;
        n = Long_fromNumber(b_value * 1.0E15 / o + 0.5);
    }
    m = 16;
    d = jl_AbstractStringBuilder170_trailingDecimalZeros166(n);
    if (d > 0) {
        m = m - d | 0;
    }
    if (k < 7 && k >=  -3) {
        if (k >= 0) {
            i = k + 1 | 0;
            m = jl_Math591_max186(m, i + 1 | 0);
            k = 0;
        } else if (k < 0) {
            n = Long_div(n, jl_AbstractStringBuilder170.longPowersOfTen178.data[ -k | 0]);
            m = m - k | 0;
            k = 0;
        }
    }
    ...
    jl_AbstractStringBuilder170_insertSpace175($this, a_target, a_target + (h + m | 0) | 0);
    if (g == 0) {
        j = a_target;
    } else {
    ...
    if (k != 0) {
        ...
        if (k >= 100) {
            ...
            t = n + 1 | 0;
            s[n] = (48 + (k / 100 | 0) | 0) & 65535;
            k = k % 100;
            u = $this.buffer172.data;
            b_value = t + 1 | 0;
            u[t] = (48 + (k / 10 | 0) | 0) & 65535;
        } else if (k < 10) {
            b_value = n;
        } else {
            j = $this.buffer172.data;
            b_value = n + 1 | 0;
            j[n] = (48 + (k / 10 | 0) | 0) & 65535;
        }
        $this.buffer172.data[b_value] = (48 + k % 10 | 0) & 65535;
    }
    return $this;
}
...
function jl_AbstractStringBuilder170_insert174($this, a_index, b_obj) {
    ...
    if (b_obj === null) {
        ...
        c = jl_String1_toString14(b_obj);
    }
    return jl_StringBuilder181_insert181($this, a_index, jl_String1_wrap63(c));
}
...
function jur_AbstractCharClass$PredefinedCharacterClasses199_$clinit() {
    ...
    jur_AbstractCharClass$PredefinedCharacterClasses199_$clinit31 = function() {
        ...
        e = d.data;
        e[0] = $rt_s(10);
        e[1] = jur_AbstractCharClass$LazyUpper313_$init4();
        b[f] = d;
        c = 2;
        ...
        e = d.data;
        e[0] = $rt_s(12);
        e[1] = jur_AbstractCharClass$LazyAlpha76_$init4();
        b[c] = d;
        c = 4;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        ...
        d = e.data;
        d[0] = $rt_s(16);
        d[1] = jur_AbstractCharClass$LazyGraph292_$init4();
        b[f] = e;
        c = 8;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(21);
        e[1] = jur_AbstractCharClass$LazyJavaLowerCase93_$init4();
        b[c] = d;
        c = 13;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(23);
        e[1] = jur_AbstractCharClass$LazyJavaWhitespace565_$init4();
        b[c] = d;
        c = 15;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        d = e.data;
        d[0] = $rt_s(29);
        d[1] = jur_AbstractCharClass$LazyJavaJavaIdentifierPart390_$init4();
        b[c] = e;
        c = 21;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        ...
        e = d.data;
        e[0] = $rt_s(33);
        e[1] = jur_AbstractCharClass$LazyJavaSpaceChar294_$init4();
        b[c] = d;
        c = 25;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        d[0] = $rt_s(34);
        d[1] = jur_AbstractCharClass$LazyJavaTitleCase393_$init4();
        b[c] = e;
        f = 26;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(38);
        e[1] = jur_AbstractCharClass$LazyWord80_$init4();
        b[c] = d;
        f = 30;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        d = e.data;
        d[0] = $rt_s(63);
        d[1] = jur_AbstractCharClass$LazyRange440_$init113(2688, 2815);
        b[g] = e;
        c = 55;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(67);
        e[1] = jur_AbstractCharClass$LazyRange440_$init113(3200, 3327);
        b[g] = d;
        c = 59;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        ...
        d = e.data;
        d[0] = $rt_s(75);
        d[1] = jur_AbstractCharClass$LazyRange440_$init113(4352, 4607);
        b[g] = e;
        g = 67;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(88);
        e[1] = jur_AbstractCharClass$LazyRange440_$init113(6400, 6479);
        b[f] = d;
        g = 80;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        e[0] = $rt_s(89);
        e[1] = jur_AbstractCharClass$LazyRange440_$init113(6480, 6527);
        b[g] = d;
        c = 81;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        ...
        d = e.data;
        d[0] = $rt_s(91);
        d[1] = jur_AbstractCharClass$LazyRange440_$init113(6624, 6655);
        b[h] = e;
        g = 83;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        d = e.data;
        d[0] = $rt_s(101);
        d[1] = jur_AbstractCharClass$LazyRange440_$init113(8400, 8447);
        b[g] = e;
        h = 93;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        ...
        e = d.data;
        e[0] = $rt_s(105);
        e[1] = jur_AbstractCharClass$LazyRange440_$init113(8704, 8959);
        b[c] = d;
        g = 97;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        ...
        d = e.data;
        d[0] = $rt_s(115);
        d[1] = jur_AbstractCharClass$LazyRange440_$init113(10176, 10223);
        b[c] = e;
        g = 107;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        ...
        e = d.data;
        e[0] = $rt_s(128);
        e[1] = jur_AbstractCharClass$LazyRange440_$init113(11904, 12031);
        b[c] = d;
        f = 120;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(131);
        e[1] = jur_AbstractCharClass$LazyRange440_$init113(12288, 12351);
        b[c] = d;
        g = 123;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        d = e.data;
        d[0] = $rt_s(143);
        d[1] = jur_AbstractCharClass$LazyRange440_$init113(19904, 19967);
        b[h] = e;
        h = 135;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(152);
        e[1] = jur_AbstractCharClass$LazyRange440_$init113(56320, 57343);
        b[h] = d;
        h = 144;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        ...
        e = d.data;
        e[0] = $rt_s(162);
        e[1] = jur_AbstractCharClass$LazyRange440_$init113(65136, 65279);
        b[c] = d;
        h = 154;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(171);
        e[1] = jur_AbstractCharClass$LazyCategory132_$init152(4, 0);
        b[c] = d;
        c = 163;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        e[0] = $rt_s(172);
        e[1] = jur_AbstractCharClass$LazyCategory132_$init152(5, 1);
        b[c] = d;
        g = 164;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(174);
        e[1] = jur_AbstractCharClass$LazyCategory132_$init152(6, 1);
        b[c] = d;
        h = 166;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        ...
        e = d.data;
        e[0] = $rt_s(179);
        e[1] = jur_AbstractCharClass$LazyCategory132_$init152(10, 1);
        b[h] = d;
        g = 171;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(184);
        e[1] = jur_AbstractCharClass$LazyCategory132_$init152(14, 0);
        b[c] = d;
        c = 176;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        d[0] = $rt_s(185);
        d[1] = jur_AbstractCharClass$LazyCategoryScope495_$init154(983040, 1, 1);
        b[c] = e;
        h = 177;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(189);
        e[1] = jur_AbstractCharClass$LazyCategory132_$init154(19, 0, 1);
        b[h] = d;
        g = 181;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        d[0] = $rt_s(190);
        d[1] = jur_AbstractCharClass$LazyCategoryScope495_$init152(1643118592, 1);
        b[g] = e;
        c = 182;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        e = d.data;
        e[0] = $rt_s(193);
        e[1] = jur_AbstractCharClass$LazyCategory132_$init152(22, 0);
        b[g] = d;
        g = 185;
        e = $rt_createArray(jl_Object2, 2);
        d = e.data;
        ...
        d = e.data;
        d[0] = $rt_s(198);
        d[1] = jur_AbstractCharClass$LazyCategory132_$init152(26, 0);
        b[c] = e;
        h = 190;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        d = e.data;
        d[0] = $rt_s(200);
        d[1] = jur_AbstractCharClass$LazyCategory132_$init152(28, 1);
        b[c] = e;
        c = 192;
        d = $rt_createArray(jl_Object2, 2);
        e = d.data;
        ...
        d = e.data;
        d[0] = $rt_s(202);
        d[1] = jur_AbstractCharClass$LazyCategory132_$init152(30, 0);
        b[h] = e;
...
function jur_DecomposedCharSet205_matches78($this, a_strIndex, b_testString, c_matchResult) {
    ...
    $ba: {
        if (h < f) {
            k = jur_DecomposedCharSet205_codePointAt223($this, h, b_testString, f);
            while (j < 4) {
                if (jur_Lexer642_hasDecompositionNonNullCanClass226(k) == 0) {
                    m = d.data;
                    a_strIndex = j + 1 | 0;
                    m[j] = k;
                } else {
                    e = jur_Lexer642_getDecomposition224(k).data;
                    if (e.length != 2) {
                        k = d.data;
                        a_strIndex = j + 1 | 0;
                        k[j] = e[0];
    ...
    if (j != $this.decomposedCharLength206) {
        return  -1;
    }
    k = 0;
    while (true) {
        ...
        if (d.data[k] != $this.decomposedChar208.data[k]) {
            break;
        }
        k = k + 1 | 0;
    }
...
function ju_TreeMap228_put252($this, a_key, b_value) {
    ...
    a_key = ju_TreeMap228_findExact253($this, a_key);
    c = ju_AbstractMap$SimpleEntry248_setValue254(a_key, b_value);
    ju_AbstractMap$SimpleEntry248_setValue254(a_key, b_value);
    ...
    while (g < jl_String1_length2(a_encoded)) {
        ...
        if (h == 0 && i >= 128) {
            if (d > 0) {
                j = b.data;
                m = e + 1 | 0;
                j[e] = otciu_UnicodeHelper$Range632_$init298(f, f + d | 0, ju_Arrays414_copyOf299(c, d));
                e = m;
            }
            f = f + (d + i | 0) | 0;
            d = 0;
            ...
            if (j < k.length) {
                ...
                o = b.data;
                n = e + 1 | 0;
                o[e] = otciu_UnicodeHelper$Range632_$init298(f, f + d | 0, ju_Arrays414_copyOf299(c, d));
                f = f + j | 0;
                d = 0;
            }
            while (true) {
...
function ju_TreeMap$EntryIterator279_next305($this) {
    ...
    c = a[b];
    $this.last284 = c;
    c = ju_TreeMap$TreeNode287_down249(c, $this.reverse286);
    if (c !== null) {
        while (c !== null) {
            d = $this.path282.data;
            b = $this.depth283;
            $this.depth283 = b + 1 | 0;
            d[b] = c;
            c = ju_TreeMap$TreeNode287_forward250(c, $this.reverse286);
        }
    }
...
function o_OntologizerClient314_$clinit() {
    ...
    o_OntologizerClient314_lambda$initWorker$2324 = function(a_hiddenRemoved, b_progressElement, c_pm) {
        ...
        f = $rt_str(c_pm.title);
        if (f !== null && jl_String1_length2(f) > 0) {
            o_ProgressElement685_setLabel$static332(b_progressElement, f, e);
        } else {
...
function o_LoadDataMessage372_createLoadDataMessage342(a_filename) {
    ...
    a_filename = $rt_ustr(a_filename);
    b.associationFilename = a_filename;
    return b;
}
...
function jur_BackReferenceSet386_find81($this, a_strIndex, b_testString, c_matchResult) {
    ...
    if (d !== null && (a_strIndex + jl_String1_length2(d) | 0) <= e) {
        ...
        while (true) {
            ...
            g = jl_String1_indexOf408(f, d, a_strIndex);
            if (g < 0) {
                return  -1;
            }
            jur_AbstractSet41_$clinit();
            if ($this.next42.matches78(g + jl_String1_length2(d) | 0, b_testString, c_matchResult) >= 0) {
                break;
            }
            a_strIndex = g + 1 | 0;
        }
...
function jur_DotQuantifierSet388_find81($this, a_res_stringIndex, b_testString, c_matchResult) {
    ...
    if (e > 0) {
        c_matchResult = jur_DotQuantifierSet388_findBackLineTerminator411($this, a_res_stringIndex, e - 1 | 0, b_testString);
    } else if (e != 0) {
        c_matchResult =  -1;
    } else {
        c_matchResult = 0;
...
function jur_UnifiedQuantifierSet398_find81($this, a_stringIndex, b_testString, c_matchResult) {
    ...
    while (e >= a_stringIndex) {
        ...
        f = e - $this.leaf101.charCount122() | 0;
        d = e;
        e = f;
    }
    return d;
...
function ju_BitSet407_nextSetBit47($this, a_fromIndex) {
    ...
    while (d < c) {
        if ($this.data408.data[d] != 0) {
            return (d * 32 | 0) + jl_Integer37_numberOfTrailingZeros71($this.data408.data[d]) | 0;
        }
        d = d + 1 | 0;
    }
    return  -1;
...
function ju_BitSet407_clear430($this, a_fromIndex, b_toIndex) {
    ...
    if (d == e) {
        f = $this.data408.data;
        f[d] = f[d] & (ju_BitSet407_trailingOneBits428($this, a_fromIndex) | ju_BitSet407_trailingZeroBits431($this, c));
    } else {
        f = $this.data408.data;
        f[d] = f[d] & ju_BitSet407_trailingOneBits428($this, a_fromIndex);
        b_toIndex = d + 1 | 0;
        while (b_toIndex < e) {
        ...
        g = $this.data408.data;
        g[e] = g[e] & ju_BitSet407_trailingZeroBits431($this, c);
    }
    ju_BitSet407_recalculateLength427($this);
    return;
}
...
function ju_BitSet407_set156($this, a_fromIndex, b_toIndex) {
    ...
    if (c == d) {
        ...
        c = $this.data408.data;
        c[d] = c[d] | ju_BitSet407_trailingOneBits428($this, b_toIndex);
    }
    return;
}
...
function ju_Arrays414_copyOf188(a_array, b_length) {
    ...
    b_length = jl_Math591_min347(b_length, c.length);
    e = 0;
    while (e < b_length) {
        d.data[e] = c[e];
        e = e + 1 | 0;
...
function jur_CharSet415_findBack77($this, a_strIndex, b_lastIndex, c_testString, d_matchResult) {
    ...
    $ba: {
        while (true) {
            ...
            b_lastIndex = jl_String1_lastIndexOf442(e, $this.ch416, b_lastIndex);
            if (b_lastIndex < 0) {
                break $ba;
            }
            if (b_lastIndex < a_strIndex) {
...
function jl_Character478_$clinit() {
    ...
    jl_Character478_toChars143 = function(a_codePoint) {
        ...
        c = b.data;
        c[0] = jl_Character478_highSurrogate465(a_codePoint);
        c[1] = jl_Character478_lowSurrogate466(a_codePoint);
        return b;
    };
...
function jur_SupplCharSet489_accepts123($this, a_strIndex, b_testString) {
    ...
    if ($this.high490 == d && $this.low491 == b_testString) {
        e = 2;
    } else {
        e =  -1;
    }
...
function jur_SupplCharSet489_$init32($this, a_ch) {
    ...
    $this.charCount95 = 2;
    $this.ch492 = a_ch;
    a_ch = jl_Character478_toChars143(a_ch).data;
    $this.high490 = a_ch[0];
    $this.low491 = a_ch[1];
    return;
}
...
function jur_SupplRangeSet500_matches78($this, a_stringIndex, b_testString, c_matchResult) {
    ...
    if (a_stringIndex < d) {
        ...
        if (e < d) {
            a_stringIndex = e + 1 | 0;
            d = jl_String1_charAt61(b_testString, e);
            if (jl_Character478_isSurrogatePair227(f, d) != 0 && $this.contains30(jl_Character478_toCodePoint319(f, d)) != 0) {
                jur_AbstractSet41_$clinit();
                return $this.next42.matches78(a_stringIndex, b_testString, c_matchResult);
            }
        }
        ...
        $ba: {
            if (jl_Character478_getType473(a_ch) == 6) {
                while (true) {
                    ...
                    a_ch = jl_String1_charAt61(d_testString, b_index);
                    if (jl_Character478_isLetterOrDigit463(a_ch) != 0) {
                        return 0;
                    }
                    if (jl_Character478_getType473(a_ch) != 6) {
                        break;
...
function jur_CompositeGroupQuantifierSet544_matches78($this, a_stringIndex, b_testString, c_matchResult) {
    ...
    f = $this.setCounter546;
    e = d +  -1 | 0;
    jur_MatchResultImpl327_setEnterCounter359(c_matchResult, f, e);
    if (e < jur_Quantifier252_min133($this.quantifier545)) {
        jur_MatchResultImpl327_setEnterCounter359(c_matchResult, $this.setCounter546, 0);
        return  -1;
    }
    jur_AbstractSet41_$clinit();
...
function ju_ArrayList551_ensureCapacity176($this, a_minCapacity) {
    if ($this.array553.data.length < a_minCapacity) {
        $this.array553 = ju_Arrays414_copyOf251($this.array553, $this.array553.data.length + jl_Math591_max186(5, $this.array553.data.length / 2 | 0) | 0);
    }
    return;
}
...
function jl_String1_$clinit() {
    ...
    jl_String1_$init301 = function($this, a_characters) {
        ...
        jl_Object2_$init8($this);
        c = b.length;
        $this.characters558 = $rt_createCharArray(c);
        d = 0;
        while (d < c) {
            $this.characters558.data[d] = b[d];
            d = d + 1 | 0;
        }
        return;
    };
...
function jur_Pattern607_split530($this, a_inputSeq, b_limit) {
    ...
    $ba: {
        ...
        if (b_limit == 0) {
            while (true) {
                ...
                if (jl_String1_length2(jl_String1_toString14(ju_ArrayList551_get95(c, h))) != 0) {
                    break;
                }
                ju_ArrayList551_remove96(c, h);
            }
        }
    }
    if (h < 0) {
    ...
    return ju_AbstractCollection265_toArray285(c, $rt_createArray(jl_String1, h));
}
    ...
    if (b_term !== null && b_term instanceof jur_LeafSet94 == 0) {
        switch (c) {
            ...
            case -536870789:
                ...
                e =  -536870849;
                c = $this.compCount609 + 1 | 0;
                $this.compCount609 = c;
                jur_CompositeGroupQuantifierSet544_$init500(f, d, b_term, a_last, e, c);
                b_term.setNext79(f);
                return f;
            default:
        }
        ...
        $ba: {
            ...
            if ((d &  -2147418113) ==  -2147483608) {
                    ...
                    $bc: {
                        switch (d) {
                            ...
                            case -536870821:
                                ...
                                b = jur_Pattern607_processRange555($this, g, a_last);
                                if (jur_Lexer642_peek519($this.lexemes613) !=  -536870819) {
                                    $rt_throw(jur_PatternSyntaxException593_$init511($rt_s(203), jur_Lexer642_toString14($this.lexemes613), jur_Lexer642_getIndex232($this.lexemes613)));
                                }
                ...
                if (d >= 0 && jur_Lexer642_isSpecial523($this.lexemes613) == 0) {
                    ...
                    if (d !=  -536870871) {
                        b = new jur_PatternSyntaxException593;
                        if (jur_Lexer642_isSpecial523($this.lexemes613) == 0) {
                            g = jl_Character478_toString441(d & 65535);
                        } else {
                            g = jur_Lexer642_peekSpecial525($this.lexemes613).toString14();
                        }
                        jur_PatternSyntaxException593_$init512(b, g, jur_Lexer642_toString14($this.lexemes613), jur_Lexer642_getIndex232($this.lexemes613));
                        $rt_throw(b);
                    }
                    if (c != 0) {
                        $rt_throw(jur_PatternSyntaxException593_$init511($rt_s(203), jur_Lexer642_toString14($this.lexemes613), jur_Lexer642_getIndex232($this.lexemes613)));
...
function ju_HashMap622_$init559($this, a_capacity, b_loadFactor) {
    ...
    if (a_capacity >= 0 && b_loadFactor > 0.0) {
        a_capacity = ju_HashMap622_calculateCapacity562(a_capacity);
        $this.elementCount626 = 0;
        $this.elementData625 = ju_HashMap622_newElementArray563($this, a_capacity);
...
function ju_HashMap622_putImpl565($this, a_key, b_value) {
    ...
    if (a_key === null) {
        ...
        if (c === null) {
            ...
            d = $this.elementCount626 + 1 | 0;
            $this.elementCount626 = d;
            if (d > $this.threshold627) {
                ju_HashMap622_rehash568($this);
            }
        }
    } else {
        e = ju_HashMap622_computeHashCode569(a_key);
        f = e & ($this.elementData625.data.length - 1 | 0);
        c = ju_HashMap622_findNonNullKeyEntry561($this, a_key, f, e);
        if (c === null) {
            $this.modCount623 = $this.modCount623 + 1 | 0;
            c = ju_HashMap622_createHashedEntry567($this, a_key, f, e);
            g = $this.elementCount626 + 1 | 0;
            $this.elementCount626 = g;
            if (g > $this.threshold627) {
                ju_HashMap622_rehash568($this);
            }
        }
    }
...
function ju_HashMap622_rehash571($this, a_capacity) {
    ...
    a_capacity = ju_HashMap622_newElementArray563($this, c);
    d = 0;
    e = c - 1 | 0;
    while (d < $this.elementData625.data.length) {
        f = $this.elementData625.data[d];
    ...
    $this.elementData625 = a_capacity;
    ju_HashMap622_computeThreshold564($this);
    return;
}
    ...
    while (true) {
        ...
        $ba: {
            if ($this.lookAhead654 != 92) {
                ...
                try {
                    $this.lookAheadST643 = jur_AbstractCharClass18_getPredefinedClass27(e, b);
                } catch ($e) {
                    $je = $e.$javaException;
...
o_WorkerMessage31, "ontologizer.WorkerMessage", jl_Object2, [otj_JSObject29], 0, o_WorkerMessage31_$clinit, ['o_WorkerMessage31_createWorkerMessage57', 'o_WorkerMessage31_createWorkerMessage$js_body$_3658', 'o_WorkerMessage31_$clinit31'], [],
